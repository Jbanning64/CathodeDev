...
"></asp:SqlDataSource>
                             ...
                             <asp:SqlDataSource ID="sqlEB2NoCathode" runat="server" ProviderName="<%$ ConnectionStrings:CathodeConnString.ProviderName %>" ConnectionString="<%$ ConnectionStrings:CathodeConnString %>" SelectCommand="SELECT GunNumber 
FROM vwEBGunNoCathode
        ...
        <div class="row">
            ...
            <section class="col-md-3" aria-labelledby="hostingTitle">
                ...
                <br />
                 ...
                 <br />
                 <br />
                 <h3 id="grdTitleEB2-22">Guns No Cathode</h3>
                 <asp:GridView ID="grdEB2NoCathode" runat="server" AutoGenerateColumns="False" DataSourceID="SqlEB2NoCathode" ShowHeader="false" EmptyDataText="All Guns Filled" ShowHeaderWhenEmpty="true">
                     <Columns>
                         <asp:BoundField DataField="GunNumber" ReadOnly="True" SortExpression="GunNumber" />
                     </Columns>
                 </asp:GridView>
